...
(function() {
    ...
    function createWidget(placeHolder) {
        ...
        (function() {
            ...
            var font = placeHolder.getAttribute("font") || "Roboto, Arial, Helvetica";
            ...
            getPriceData(coinId, function(coinData) {
                getData(coinId, function(data) {
                    ...
                    footerBlock.appendChild(createButtonsSection(checkboxesSection, height, coinId, localeAtt, chartId, type));
        ...
        function getData(coinId, callback) {
            ...
            return fetch("https://api.coin-stats.com/v2/coinchart/" + coinId + "?type=" + type).then(function(res) {
                return res.json()
            }).then(function(res) {
        ...
        function getCandleChartData(id, callback) {
            ...
            return fetch("https://api.coin-stats.com/v2/coinchart/" + id + "/candle?type=" + type + "&currency=" + currency).then(function(res) {
                return res.json()
            }).then(function(res) {
        ...
        function getPriceData(coinId, callback) {
            return fetch("https://api.coin-stats.com/v2/coins/" + coinId).then(function(res) {
                return res.json()
            }).then(function(res) {
                return callback(res)
            })
        ...
        function createCredits(textColor, font) {
            ...
            anchor.innerHTML = "Powered by CoinStats";
        ...
        function createTypeSwitcher(buttonsBlock, container, height, coinId, localeAtt, chartId, type) {
            ...
            var handleClick = function handleClick() {
                ...
                if (isLineChart) {
                    ...
                    getCandleChartData(coinId, function() {
        ...
        function createCheckboxesSection(localeAtt, height, chartId, type) {
            ...
            symbols.forEach(function(symbol, index) {
                ...
                label.setAttribute("class", "pure-material-checkbox" + " " + "chart-checkbox-" + symbol.toLowerCase());
        ...
        function handleCheckBoxChange(container, height, localeAtt, chartId, type, event) {
            ...
            if (checkedBoxes.length === 0) {
                ...
                getCandleChartData(globalCoinId, function() {
                    createCandleChart(height, chartId, showCurrency)
                }, globalTimeInterval, event.target.name)
            }
        }
        ...
        function createFirstRow(coinData, colors, type) {
            ...
            coinNameContainer.addEventListener("click", function() {
                window.open("https://coinstats.app/coins/" + coinData.i)
            });
        ...
        function createPercentNode(colors) {
            ...
            percnetNode.innerHTML = '<span style="margin-right: 10px; opacity: 0.8;">' + globalTimeInterval.toUpperCase() + " Change</span>" + arrowSvg + ('<span style="color: ' + colors[status] + ';">' + (Math.abs(diffPercent).toFixed(2) + "%") + "</span>");
        ...
        function createCandleChart(height, chartId, currency) {
            function formatTooltip(tooltip) {
                ...
                var result = "\n      <b>" + formateDate(x) + "</b>\n      <br/>Open: " + currencySymbol + formatePrice(point.open, globalCurrency) + "\n      <br/>High: " + currencySymbol + formatePrice(point.high, globalCurrency) + "<br/>Low: " + currencySymbol + formatePrice(point.low, globalCurrency) + "<br/>Close: " + currencySymbol + formatePrice(point.close, globalCurrency) + "<br/>";
                return result
            }
            var config = {
                navigator: {
        ...
        function createChart(container, height, locale, chartId, type) {
            ...
            globalData.forEach(function(value) {
                ...
                coinChartInfoETHConvert.push(value[3] / .24986247573117534)
            });
            ...
            if (checkedBTC) {
                ...
                config.yAxis.push({
                    ...
                    labels: {
                        formatter: function formatter() {
                            return '<span class="coin-chart-price">\n        аёї' + formatePrice(this.value, "BTC", locale) + "\n          </span>"
                        },
                        style: {
            ...
            if (checkedETH) {
                ...
                config.yAxis.push({
                    ...
                    labels: {
                        formatter: function formatter() {
                            return '<span class="coin-chart-price">\n          Оћ' + formatePrice(this.value, "ETH", locale) + "\n            </span>"
                        },
                        style: {
                            color: chartTextColor,
                            opacity: .8
    ...
    function getCurrencies(callback) {
        return fetch("https://api.coin-stats.com/v3/currencies").then(function(resFiats) {
